...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('commProd_userprofile', 'pic_url',
                      self.gf('django.db.models.fields.CharField')(default='/public/img/placeholder.jpg', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.pic_url'
        db.delete_column('commProd_userprofile', 'pic_url')
