...
class Email(models.Model):
    ...
    def sendConfirmEmail(self):
        content = email_templates.alt_email['content'] % (self.user_profile.user.first_name, self.email, settings.BASE_URL_PROD + '/confirm_email/' + self.activation_key + '/')
...
class PasswordReset(models.Model):
    ...
    def sendConfirmEmail(self):
        content = email_templates.forgot_password['content'] % (self.user_profile.user.first_name, settings.BASE_URL_PROD + '/reset_password/' + self.activation_key + '/')
